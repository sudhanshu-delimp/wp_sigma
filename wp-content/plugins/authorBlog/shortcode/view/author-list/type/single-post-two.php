  ...
  <div class="col-sm-3 sbs-item-card">
    <div class="card" style="width: 100%;">
      ...
      if($attributes['loader'] === 'false' || $loader === 'false'){
        ...
        ?>
        <span class="card_stickyOpinion"><?php echo  __($post->user_role,'sbs_author_blog'); ?></span>
        <?php
      }
      ?>
      ...
      <div class="card-head">
        <small>
          <a href="<?php echo get_site_url().'/'.$sbs_current_lang.'/author/'.$post->user_nicename; ?>"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $post->display_name; ?></font></font></a>
        </small>
        <span class="card_OpinionWriter"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo __('Opinion Writer','sbs_author_blog'); ?></font></font></span>
      </div>
      <div class="card-body">
        <?php
        if($attributes['loader'] === 'false' || $loader === 'false'){
      ...
      if($attributes['loader'] === 'false' || $loader === 'false'){
        ...
        <a href="<?php echo $post->post_link;?>" class="view-btn btn btn-primary"><?php echo __('Read Article','sbs_author_blog'); ?></a>
        <?php
      }
      else{
        ?>
