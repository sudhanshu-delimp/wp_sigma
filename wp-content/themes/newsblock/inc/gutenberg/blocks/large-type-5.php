 ...
 */
function csco_canvas_register_layout_large_type_5( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		...
		'name'        => esc_html__( 'Large 5', 'newsblock' ),
		'template'    => get_template_directory() . "/template-parts/blocks/{$layout}.php",
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" stroke="#2d2d2d"><rect height="42" rx="3" stroke-width="1.5" width="50" x="1" y="1"/><path d="m2.5 5.5h48" stroke-linecap="square" stroke-width="1.5"/><path d="m17.5 6.5v31" stroke-linecap="square" stroke-width="1.5"/><path d="m34 6v33" stroke-linecap="square" stroke-width="1.5"/><path d="m2 39h48" stroke-linecap="square" stroke-width="1.5"/><g stroke-linecap="round" stroke-linejoin="round"><path d="m4.5 27.5h7"/><path d="m4.5 30.5h5"/><path d="m4.5 33.5h8"/><path d="m22 27.5h7"/><path d="m22 30.5h5"/><path d="m22 33.5h8"/><path d="m39 27.5h7"/><path d="m39 30.5h5"/><path d="m39 33.5h8"/></g></g></svg>',
		'sections'    => array(
			'general'    => array(
		...
		'fields'      => array_merge(
			array(
				...
				array(
					'key'        => 'padding',
					'label'      => esc_html__( 'Gap Padding', 'newsblock' ),
					'type'       => 'dimension',
					'default'    => '2px',
					'section'    => 'general',
					'responsive' => true,
...
add_filter( 'canvas_block_layouts_canvas/posts', 'csco_canvas_register_layout_large_type_5' );
 ...
 */
function csco_canvas_posts_query_args_large_type_5( $args, $attributes, $options ) {

	if ( 0 !== strpos( $attributes['layout'], 'large-type-5' ) ) {
		return $args;
	}
...
add_filter( 'canvas_block_posts_query_args', 'csco_canvas_posts_query_args_large_type_5', 10, 3 );
