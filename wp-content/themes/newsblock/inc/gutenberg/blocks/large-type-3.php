 ...
 */
function csco_canvas_register_layout_large_type_3( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		...
		'name'        => esc_html__( 'Large 3', 'newsblock' ),
		'template'    => get_template_directory() . "/template-parts/blocks/{$layout}.php",
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g stroke="#2d2d2d"><rect height="42" rx="3" stroke-width="1.5" width="50" x="1" y="1"/><path d="m2.5 5.5h48" stroke-linecap="square" stroke-width="1.5"/><path d="m2.5 27.5h48" stroke-linecap="square" stroke-width="1.5"/></g><path d="m13 24h25v10h-25z" fill="#2d2d2d"/><path d="m16.5 27.5h17" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"/><path d="m16.5 30.5h13" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"/><path d="m14 37h5" stroke="#2d2d2d" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',
		'sections'    => array(
			'general'    => array(
...
add_filter( 'canvas_block_layouts_canvas/posts', 'csco_canvas_register_layout_large_type_3' );
 ...
 */
function csco_canvas_posts_query_args_large_type_3( $args, $attributes, $options ) {

	if ( 0 !== strpos( $attributes['layout'], 'large-type-3' ) ) {
		return $args;
	}
...
add_filter( 'canvas_block_posts_query_args', 'csco_canvas_posts_query_args_large_type_3', 10, 3 );
