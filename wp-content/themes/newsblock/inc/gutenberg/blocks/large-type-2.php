...
function csco_canvas_register_layout_large_type_2( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		...
		'name'        => esc_html__( 'Large 2', 'newsblock' ),
		'template'    => get_template_directory() . "/template-parts/blocks/{$layout}.php",
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" transform="translate(1 1)"><g stroke="#2d2d2d"><rect height="42" rx="3" stroke-width="1.5" width="50"/><rect height="6" rx="1" stroke-width="1.5" transform="matrix(-1 0 0 1 19 0)" width="11" x="4" y="10"/><rect height="6" rx="1" stroke-width="1.5" transform="matrix(-1 0 0 1 19 0)" width="11" x="4" y="19"/><rect height="6" rx="1" stroke-width="1.5" transform="matrix(-1 0 0 1 19 0)" width="11" x="4" y="28"/><path d="m1.5 4.5h48" stroke-linecap="square" stroke-width="1.5"/><path d="m1 38h48" stroke-linecap="square" stroke-width="1.5"/></g><path d="m21 20h25v10h-25z" fill="#2d2d2d"/><path d="m24.5 23.5h17" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"/><path d="m24.5 26.5h13" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"/><path d="m22 33h5" stroke="#2d2d2d" stroke-linecap="round" stroke-linejoin="round"/></g></svg>',
		'sections'    => array(
			'general'    => array(
 ...
 */
function csco_canvas_posts_query_args_large_type_2( $args, $attributes, $options ) {

	if ( 0 !== strpos( $attributes['layout'], 'large-type-2' ) ) {
		return $args;
	}
...
add_filter( 'canvas_block_posts_query_args', 'csco_canvas_posts_query_args_large_type_2', 10, 3 );
