 ...
 */
function csco_canvas_register_layout_large_type_8( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		...
		'name'        => esc_html__( 'Large 8', 'newsblock' ),
		'template'    => get_template_directory() . "/template-parts/blocks/{$layout}.php",
		'icon'        => '<svg height="44" viewBox="0 0 52 44" width="52" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" stroke="#2d2d2d"><rect height="42" rx="3" stroke-width="1.5" width="50" x="1" y="1"/><path d="m4.333333 27.5h4.666667" stroke-linecap="round" stroke-linejoin="round"/><path d="m4.333333 30.5h3.333334" stroke-linecap="round" stroke-linejoin="round"/><path d="m4.333333 33.5h5.333334" stroke-linecap="round" stroke-linejoin="round"/><path d="m2.5 5.5h48" stroke-linecap="square" stroke-width="1.5"/><path d="m2 39h48" stroke-linecap="square" stroke-width="1.5"/><g stroke-linecap="round" stroke-linejoin="round"><path d="m16 27.5h5.25"/><path d="m16 30.5h3.75"/><path d="m16 33.5h6"/><path d="m29 27.5h5.25"/><path d="m29 30.5h3.75"/><path d="m29 33.5h6"/><path d="m42 27.5h5.25"/><path d="m42 30.5h3.75"/><path d="m42 33.5h6"/></g><path d="m26 7v31" stroke-linecap="square" stroke-width="1.5"/><path d="m39 6v33" stroke-linecap="square" stroke-width="1.5"/><path d="m13 6v33" stroke-linecap="square" stroke-width="1.5"/></g></svg>',
		'sections'    => array(
			'general'    => array(
...
add_filter( 'canvas_block_layouts_canvas/posts', 'csco_canvas_register_layout_large_type_8' );
 ...
 */
function csco_canvas_posts_query_args_large_type_8( $args, $attributes, $options ) {

	if ( 0 !== strpos( $attributes['layout'], 'large-type-8' ) ) {
		return $args;
	}
...
add_filter( 'canvas_block_posts_query_args', 'csco_canvas_posts_query_args_large_type_8', 10, 3 );
