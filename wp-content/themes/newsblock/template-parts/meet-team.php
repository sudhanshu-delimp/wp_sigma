...
if ( csco_coauthors_enabled() ) {
	...
	$authors = get_users( apply_filters( 'csco_get_users_args', array(
				...
				<div class="cs-author">
					...
					<div class="cs-author-posts">
						<h5 class="cs-author-title-posts">
							<?php esc_html_e( 'Latest from ', 'newsblock' ); ?> <?php echo esc_html( get_the_author_meta( 'display_name', $author->ID ) ); ?>
						</h5>
