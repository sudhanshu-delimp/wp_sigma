...
<div id="primary" class="cs-content-area">
	...
	<h1><?php echo get_the_category_by_ID($category->cat_ID); ?></h1>
		...
		foreach($recent_posts as $key=>$post){
			...
			if($post->vidoe_url==''){
				...
				<div class="cs-overlay-background">
					<a href="<?php echo get_permalink($post->ID);?>" class="newanchor"><img class="card-img-top" src="<?php echo $post_image;?>" alt="Card image cap"></a>


				</div>

				<div class="cs-overlay-content">
											<span><a href="<?php echo get_permalink($post->ID);?>"><?php echo __('Read More','sbs_author_blog'); ?></a></span>
...
<?php
echo do_shortcode("[show_latest_post_author category_id='{$category->cat_ID}' module_type ='two' loader='false' limit='3']");
echo "<hr>";
